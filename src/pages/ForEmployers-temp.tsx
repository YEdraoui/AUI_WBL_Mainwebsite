        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" onClick={() => window.open("https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university", "_blank")} className="bg-white text-primary hover:bg-white/90 text-lg px-8 py-4">
                Partner With Us
              </Button>
              <Button variant="outline" size="lg" onClick={() => window.open("https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university", "_blank")} className="border-white text-white hover:bg-white hover:text-primary text-lg px-8 py-4">
                Request a Call
              </Button>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {tracks.map((track, index) => <Card key={index} className={`relative overflow-hidden hover:shadow-aui transition-all duration-300 h-full ${track.colors.border}`}>
              <CardContent className="p-6 h-full flex flex-col">
                ...
                <Button className={`w-full text-white hover:opacity-90 ${track.colors.bg}`} onClick={() => window.open("https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university", "_blank")}>
...
const PartnershipSupport = () => {
  ...
  return <section className="py-16 bg-muted/30">
      <div className="container mx-auto px-4">
          ...
          <Card className="p-8">
            <CardContent className="pt-6">
              ...
              <div className="space-y-4">
                <Button className="w-full" size="lg" onClick={() => window.open("https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university", "_blank")}>
                  Start Partnership
                </Button>
              </div>
            </CardContent>
        ...
        {/* Calendly Widget Section - positioned after Partnership Support */}
        <section className="relative py-24 bg-background overflow-hidden mt-16">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="mt-16">
              ...
              <p className="text-center text-sm text-muted-foreground mt-3">
                If the scheduler doesn't load, open it here: <a className="underline text-primary" href="https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university?primary_color=1c9551" target="_blank" rel="noopener noreferrer">Calendly link</a>
              </p>
            </div>
          </div>
        </section>
              ...
              <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    size="lg"
                    onClick={() => window.open("https://calendly.com/s-elabidi-aui/meeting-with-al-akhawyan-university", "_blank")}
                    disabled={isSubmitting}
                  >
...
const FAQ = () => {
  ...
  const faqs = [{
    ...
    answer: "Yes. Remote@AUI is designed for remote work. Alternance and Co-op can accommodate remote, hybrid, or on-site arrangements based on mutual agreement and project requirements."
  }, {
